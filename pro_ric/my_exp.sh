...
#     --bf16 True \
#     --use_lora False \
#     --wandb_name 'summary_pref1faithfuldeberta_offline_pro_t0.5_rate10' \
#     --reward_names 'summary,faithful,deberta' \
#     --exp_type 'summary' \

# # summary and faithful rewards
# python evaluation_vllm_all_rewards.py \
#     --base_model_name 'logs_trl_pro/summary_pref1faithfuldeberta_offline_pro_t0.5_rate10/model_iter0' \
